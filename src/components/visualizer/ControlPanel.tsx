              ...
              {(settings.backgroundStyle === "linearGradient" || settings.backgroundStyle === "radialGradient") && (
                <div className="space-y-3">
                  ...
                  <ColorPicker
                    ...
                    label="End"
                  />
                  <Button variant="secondary" size="sm" className="w-full" onClick={onRandomizeGradient}>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {settings.individualRotation
                      ...
                      : "Models rotate around their own center"}
                  </p>
                        ...
                        <div className="space-y-2 pl-2 border-l-2 border-border mt-2">
                          {regions.map((region, index) => (
                            <div key={region.id} className="flex items-center justify-between">
                              <Label className="text-xs text-muted-foreground">Auto-Rotate Region {index + 1}</Label>
                              <Switch
