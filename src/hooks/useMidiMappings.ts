...
export const MAPPABLE_CONTROLS: MappableControl[] = [
  ...
  { id: 'panelScaleX', name: 'Panel Scale X', targetType: 'setting', targetKey: 'panelScaleX', preferredMessageType: 'cc', min: 0.1, max: 1, step: 0.05 },
  { id: 'panelScaleY', name: 'Panel Scale Y', targetType: 'setting', targetKey: 'panelScaleY', preferredMessageType: 'cc', min: 0.1, max: 1, step: 0.05 },
